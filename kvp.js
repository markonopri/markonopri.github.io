...
// Calculating Rock, Paper and Scissorsbutton clicks
...
// Compare who will win and get point.
...
function pointResult(ppoints, apoints){
    ...
    aiPoints += apoints;
    pointsTxt.innerHTML = playerPoints + " points to player <br>" + aiPoints + " points to AI <br>";
